    ...
    return (
        <>
            <div
                ...
                className="group relative px-6 py-5 flex flex-row justify-between items-center border rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 cursor-pointer transition-all duration-300 ease-in-out hover:bg-gradient-to-br hover:from-blue-100 hover:to-indigo-100 hover:border-[#22C55E] hover:scale-[1.01] shadow-[0_4px_12px_rgba(0,0,0,0.08)] hover:shadow-[0_12px_24px_rgba(34,197,94,0.2)]"
            >
                ...
                <div className="flex flex-row justify-center items-start gap-4 relative z-10">
                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <p className="text-sm text-gray-600 group-hover:text-gray-700 transition-colors duration-300">
                            Import a repository into CodeBuddy
                        </p>
                    </div>
                </div>
