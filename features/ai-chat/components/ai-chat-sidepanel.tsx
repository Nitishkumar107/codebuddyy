...
import { Loader2, Send, User, Copy, Check, X, Paperclip, FileText, Code, Sparkles, MessageSquare, RefreshCw, Plus, Minus, Settings, Zap, Brain, Terminal, Search, Filter, Download, } from "lucide-react";
                            ...
                            <ReactMarkdown
                                ...
                                components={{
                                    code: ({
                                        ...
                                        // Determine if this is inline code by checking the class name
                                        const isInline = className?.includes('inline') || 
                                                    className?.includes('code-inline') || 
